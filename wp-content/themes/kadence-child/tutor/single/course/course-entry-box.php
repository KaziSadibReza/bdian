...
$default_meta            = array(
	array(
		...
		'value'      => tutor_utils()->get_option( 'enable_course_total_enrolled' ) ? tutor_utils()->count_enrolled_users_by_course() . ' course-entry-box.php' . __( 'Total Enrolled', 'tutor' ) : null,
	),
	array(
		'icon_class' => 'tutor-icon-clock-line',
		'label'      => __( 'Duration', 'tutor' ),
		'value'      => get_tutor_option( 'enable_course_duration' ) ? ( get_tutor_course_duration_context() ? get_tutor_course_duration_context() . ' course-entry-box.php' . __( 'Duration', 'tutor' ) : false ) : null,
	),
	array(
		'icon_class' => 'tutor-icon-refresh-o',
		'label'      => __( 'Last Updated', 'tutor' ),
		'value'      => get_tutor_option( 'enable_course_update_date' ) ? get_the_modified_date(get_option('date_format')) . ' course-entry-box.php' . __( 'Last Updated', 'tutor' ) : null,
	),
);
...
<div class="tutor-card tutor-card-md tutor-sidebar-card">
    ...
    <div class="tutor-card-body">
        ...
        <form method="post" class="tutor-mt-20">
            ...
            <button type="submit" class="tutor-btn tutor-btn-outline-primary tutor-btn-block" name="complete_course_btn"
        ...
        <a href="<?php echo esc_url( $first_lesson_url ); ?>"
            class="tutor-btn tutor-btn-primary tutor-btn-lg tutor-btn-block">
        ...
        <div class="tutor-course-single-btn-group  <?php echo is_user_logged_in() ? '' : 'digits-login-modal'; ?>"
            ...
            <form class="tutor-enrol-course-form" method="post">
                ...
                <button type="submit"
                    class="tutor-btn tutor-btn-primary tutor-btn-lg tutor-btn-block tutor-mt-24 tutor-enroll-course-button tutor-static-loader">
    ...
    <div class="tutor-card-footer <?php echo esc_attr( $tutor_load_sidebar_actions ? '' : 'tutor-no-border' ); ?>">
        <ul class="tutor-ul">
            ...
            <li class="tutor-d-flex<?php echo $key > 0 ? ' tutor-mt-12' : ''; ?>">
                <span class="<?php echo esc_attr( $meta['icon_class'] ); ?> tutor-color-black tutor-mt-4 tutor-mr-12"
                    aria-labelledby="<?php echo esc_html( $meta['label'] ); ?>"></span>
