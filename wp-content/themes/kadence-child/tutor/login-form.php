...
<form id="tutor-login-form" method="post">
    ...
    <div class="tutor-mb-20">
        <input type="text" class="tutor-form-control"
            placeholder="<?php esc_html_e( 'Phone Number or Email Address', 'tutor' ); ?>" name="log" value="" size="20"
            required />
    </div>

    <div class="tutor-mb-32">
        <input type="password" class="tutor-form-control" placeholder="<?php esc_html_e( 'Password', 'tutor' ); ?>"
    ...
    <div class="tutor-text-center tutor-fs-6 tutor-color-secondary tutor-mt-20">
        ...
        <a href="<?php echo esc_url( add_query_arg( $url_arg, tutor_utils()->student_register_url() ) ); ?>"
